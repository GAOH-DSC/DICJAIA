...
BLOG_EMAIL = "legaltechpythondeveloper@gmail.com"
BLOG_DESCRIPTION = "Artículos sobre las investigaciones jurídica y académicas realizada en Colombia y Latinoamérica"  # (translatable)
